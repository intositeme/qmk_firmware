...
KC_GESC       , OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), MO(1), KC_SPC, MO(2),          KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT      
),
...
[_ADJUST] = LAYOUT_planck_mit(
  ...
  [_NUMPAD] = LAYOUT_planck_mit(
    KC_NLCK, KC_P7  , KC_P8, KC_P9  , KC_PAST, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LPRN, KC_RPRN, KC_TRNS,
    KC_TRNS, KC_P4  , KC_P5, KC_P6  , KC_PSLS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX,
    KC_LSFT, KC_P1  , KC_P2, KC_P3  , KC_PMNS, KC_INS , XXXXXXX, XXXXXXX, XXXXXXX, KC_UP  , XXXXXXX, KC_TRNS,
    KC_ENT,  KC_PLUS, KC_P0, KC_PDOT, KC_EQL , KC_TRNS,          XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX       
  )
};
